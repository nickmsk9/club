...
var resize_percent = parseInt( "36" );
	...
	for (var i=0;i<images.length;i++) {
		if (images[i].className=='linked-image') {
			...
			if (images[i].width>_sw) {
				...
				div.innerHTML=_img+'&nbsp;'+'Уменьшено: '+_percent+'% от оригинала [ '+_width+' x '+_height+' ] - <font color=red>Данный размер запрещен правилами . Перезалейте картинку !</font>';
