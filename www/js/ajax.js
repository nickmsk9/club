...
function uncheck(torrent) {
     var ajax = new tbdev_ajax();
     ajax.onShow ('');
     var varsString = "";
     ajax.requestFile = "uncheck.php";
     ajax.setVar("torrent", torrent);
     ajax.method = 'POST';
     ajax.element = 'unmoderated';
     ajax.sendAJAX(varsString);
}
...
function comm_check(torrent) {
     var ajax = new tbdev_ajax();
     ajax.onShow ('');
     var varsString = "";
     ajax.requestFile = "comm_check.php";
     ajax.setVar("torrent", torrent);
     ajax.method = 'POST';
     ajax.element = 'commcheck';
     ajax.sendAJAX(varsString);
}

function comm_uncheck(torrent) {
     var ajax = new tbdev_ajax();
     ajax.onShow ('');
     var varsString = "";
     ajax.requestFile = "comm_uncheck.php";
     ajax.setVar("torrent", torrent);
     ajax.method = 'POST';
     ajax.element = 'communcheck';
     ajax.sendAJAX(varsString);
}