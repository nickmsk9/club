...
if(! defined('FILE_CACHE_MAX_FILE_AGE') ) 	define ('FILE_CACHE_MAX_FILE_AGE', 186400);				// How old does a file have to be to be deleted from the cache
if(! defined('FILE_CACHE_SUFFIX') ) 		define ('FILE_CACHE_SUFFIX', '.cache.txt');			// What to put at the end of all files in the cache directory so we can identify them
...
if(! defined('FILE_CACHE_DIRECTORY') ) 		define ('FILE_CACHE_DIRECTORY', './cache/posters');				// Directory where images are cached. Left blank it will use the system temporary directory (which is better for security)
...
if(! defined('NOT_FOUND_IMAGE') )		define ('NOT_FOUND_IMAGE', './pic/img-error.gif');								// Image to serve if any 404 occurs 
if(! defined('ERROR_IMAGE') )			define ('ERROR_IMAGE', './pic/img-error.gif');									// Image to serve if an error occurs instead of showing error message 
