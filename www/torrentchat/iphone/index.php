...
<title><?php echo $iphone_language[0];?></title>

<style type="text/css" media="screen">@import "css/cometchat.css";</style>
<script type="text/javascript" charset="utf-8" src="../cometchatjs.php?silent=true&callbackfn=iphone"></script>
...
<div id="whosonline">
	<div id="header" class="header">
		...
		<div class="roundedcenter"><?php echo $iphone_language[1];?></div>
		<div class="roundedright"><?php echo $iphone_language[2];?></div>
