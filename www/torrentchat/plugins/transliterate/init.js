	...
	$.cctransliterate = (function () {
        ...
        return {
			...
			init: function (id) {
				...
				window.open (baseUrl+'plugins/transliterate/index.php?id='+id+'&basedata='+baseData, 'transliterate',"status=0,toolbar=0,menubar=0,directories=0,resizable=0,location=0,status=0,scrollbars=0, width=430,height=220"); 
			}
