...
?>
<br><a href="#" class="toggle" title="Включить/выключить редактор BBCode"><b>[Включить/выключить редактор BBCode]</b></a>&nbsp;&nbsp;&nbsp;&nbsp;<b><br><br>
<span style="cursor: pointer;" onclick="javascript: show_hide('s')"><img border="0" src="pic/plus.gif" id="pics" alt="<?=$lang['n_show'];?>"></span>&nbsp;
...
function cats(type) {
     ...
     ajax.onShow ('');
     var varsString = "";
     ajax.requestFile = "upload_new_shab.php";
     ajax.setVar("cats", type);
     ajax.method = 'GET';
     ajax.element = 'upload_form';
